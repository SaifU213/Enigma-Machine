...
public class Enigma_Encryptor {
    public static final char NOTCH = 'A';
    ...
    public static String enigmaEncryptor(String message, char settingF, char settingM, char settingS) {
        String label     = "_.ABCDEFGHIJKLMNOPQRSTUVWXYZ"; //28 letters
        ...
        String rotorM    = "QAZWSXE .DCRFVTGBYHNUJMIKOLP";
        ...
        do {
            do {
                do {
                    ...
                    letter = plugBoard.charAt(position); //Plug board comparison
